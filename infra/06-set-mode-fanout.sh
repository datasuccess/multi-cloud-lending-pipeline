...
case "${MODE}" in
  test)
    ...
    CRONS=("${PHASE2_TEST_CRONS[@]}")
    MIN_ROWS_ARR=("${PHASE2_TEST_MIN_ROWS[@]}")
    ROWS_PER_RUN_ARR=("${PHASE2_TEST_ROWS_PER_RUN[@]}")
  ...
  prod)
    ...
    CRONS=("${PHASE2_PROD_CRONS[@]}")
    MIN_ROWS_ARR=("${PHASE2_PROD_MIN_ROWS[@]}")
    ROWS_PER_RUN_ARR=("${PHASE2_PROD_ROWS_PER_RUN[@]}")
    LV_PERIOD=86400
